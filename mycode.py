...
print()
print("Welcome to DHS! I hope you are excited! Please answer the following questions truthfully and we'll suggest a CCA for you!")
...
tech3 = input("I know how to edit codes.")
